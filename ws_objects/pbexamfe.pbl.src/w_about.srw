...
int li_year
li_year = Year ( Today() )
st_3.text = "$$HEX2$$a9002000$$ENDHEX$$" + String (li_year, "####" ) + " Appeon Limited.  All rights reserved."
...
long backcolor = 73955432
boolean enabled = false
string text = "$$HEX2$$a9002000$$ENDHEX$$yyyy Appeon Limited. All rights reserved."
alignment alignment = center!
boolean focusrectangle = false
end type
