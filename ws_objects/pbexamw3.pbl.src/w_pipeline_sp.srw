...
//add by ykg start
//execute immediate "select isnull((select top(1) 1 from full_sales_orders),0)";
//if sqlca.SQLCode <> -1 then 

long li_count
select count(*) into :li_count  from pg_tables where schemaname = 'public' and tablename = 'full_sales_orders';
 if li_count >0  then
//add end
